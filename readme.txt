=== CMS2CMS: Automated b2evolution to WordPress Migration   ===
...
Automated migration plugin which helps transfer content from b2evolution to WordPress.

== Description ==

CMS2CMS will assist you in migrating your b2evolution data to WordPress in automated way. No more copy-pasting work.
...
1. Free Demo Version is available to see how the plugin works (transfers limited amount of data).
...
= CMS2CMS b2evolution to WordPress migration plugin makes your data transfer simple and quick. Apart from this, you may always count on our assistance: =
* Phone support – 24/7
